...
values."
  (setq-default
   ...
   '(
     ...
     ;; irony
     (ycmd :variables
           ycmd-server-command (list "python" (file-truename "~/build/ycmd/ycmd"))
